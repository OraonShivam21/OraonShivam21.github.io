      ...
      <div className="project-details">
        <div className="project-card">
          ...
          <div className="project-title-desc-stack">
            ...
            <p className="project-description">
              The Tracker Jet App is a responsive website that offers students
              an all-in-one study tracking platform, which helps them with time
              management while doing their assignments. The students can easily
              interact with all the functionalities and improve their time
              management skills while restricting the time for their
              assignments.
            </p>
        ...
        <div className="project-card">
          ...
          <div className="project-title-desc-stack">
            ...
            <p className="project-description">
              The WonderWave Travels is a responsive website which offers the
              travellers with the best India Tour packages, where they can tour
              almost every part of India with the hand-picked packages given in
              the website.
            </p>
            <h3 className="project-tech-stack">
